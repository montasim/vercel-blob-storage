 ...
 * environment such as development, staging, (users) acceptance testing (UAT), test, and production. Using these constants
 ...
 * @property {string} UAT - Represents the (users) acceptance testing environment.
